...
menu = "\n++++ Welcome to NYUSH Chatroom, feel free to chat with friends or explore interesting functions\n \
        List Users : List all the online users\n \
        Connect to : Build connection with target user\n \
        Search Poem : Get sonnet of number <#> \n \
        Search History : Search your chat logs where <term> appears\n \
        Chatbot: Chat with AI (ChatGPT) \n \
        Time: Get current time \n \
        Snake: Play a snake game \n\n"
