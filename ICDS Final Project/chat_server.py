...
openai.api_key = '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'
...
class Server:
    def __init__(self):
        ...
        # self.sonnet_f.close()
# ==============================================================================
# A dictionary of all public keys, with username as keys and [M, e] as values
        self.MEs = {}
# ==============================================================================
...
# ==============================================================================
# Record public keys
            elif msg["action"] == "send_keys":
                self.MEs[self.logged_sock2name[from_sock]] = [msg["M"], msg["e"]]
                print("Received:", msg["M"], msg["e"])
# ==============================================================================
# ==============================================================================
...
#==============================================================================
# encrypt the message
                    text = encrypt(msg["message"], self.MEs[g][0], self.MEs[g][1])
#==============================================================================
                    mysend(to_sock, json.dumps(
                        {"action": "exchange", "from": msg["from"], "message": text}))
# ==============================================================================
...
#                ChatGPT
#==============================================================================       
            elif msg["action"] == "ChatGPT": #save the history for each person 
                prompt=msg["prompt"]
                ...
                print(reply)
                mysend(from_sock, json.dumps({"action":"ChatGPT", "results":reply}))                   
# ==============================================================================
...
# ==============================================================================
                ...
                my_game = Game()
                a= my_game.play()
                mysend(from_sock, json.dumps({"action":"game", "results":a}))    
        else:
